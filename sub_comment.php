...
<body>
		<?php
   		...
   		?> 
			...
			<form class="form-action" action="insert_sub_comment.php" method="post" enctype="multipart/form-data">
			
				<h3>Comment</h3> 
			<div class="form-group">
        <div class="form-group">
            <label>Name:</label>
			<input type="name" class="form-control" style="display:none;" placeholder="Enter name" value="<?php echo $blog_id; ?>" name="blog_no">
